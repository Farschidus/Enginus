...
namespace Enginus.Navigation
{
    ...
    public class ConvexPolygon
    {
        ...
        public ConvexPolygon(Point position) : this(position, 50, 50) { }
        /// <summary>
        /// Create a rectangle convex polygon at <paramref name="position"/> of <paramref name="width"/>x<paramref name="height"/>
        /// </summary>
        /// <param name="position"></param>
        /// <param name="halfWidth"></param>
        /// <param name="halfHeight"></param>
        public ConvexPolygon(Point position, int halfWidth, int halfHeight)
        {
        ...
        public void GenerateEdges()
        {
            ...
            // Add the final edge (n-1)->(0) to close the polygon loop.
