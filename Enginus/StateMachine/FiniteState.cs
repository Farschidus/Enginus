...
namespace Enginus.StateMachine
{
    ...
    */
    ...
    {
        protected Dictionary<Transition, StateID> table = new Dictionary<Transition, StateID>();
        protected StateID stateID;
        protected SceneObject.SceneObject sceneObj;
        public StateID ID 
        { 
            get { return stateID; }
        }
        ...
        public void AddTransition(Transition trans, StateID id)
        {
            ...
            // check if the current transition was already inside the table
        ...
        /// <summary>
        /// This method returns the new state the FSM should be if this state receives a transition
        /// </summary>
        ...
        /// NPC is a reference to the object that is controlled by this class
        /// </summary>
        public abstract void Act(ScreenManager screenManager);
    }
}