...
namespace Enginus.MenuScreens
{
    ...
    class MainMenu : Menu
    {
        ...
        void PlayGameMenuEntrySelected(object sender, PlayerIndexEventArgs e)
        {
            ...
            Loading.Load(ScreenManager, true, e.PlayerIndex, GameSceneManager.InitNextScene("SpaghettiOut", ScreenManager, ScreenManager.State.PlayerPosition, ScreenManager.State.PlayerDirection, ScreenManager.State.PlayerLayerDepth));
        }
        /// <summary>
