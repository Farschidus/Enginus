...
namespace Enginus.Particle
{
    ...
    {        
        ...
        protected override void InitializeConstants()
        {
            ...
            minRotationSpeed = -MathHelper.Pi / 5;
            maxRotationSpeed = MathHelper.Pi / 5;

            blendState = BlendState.AlphaBlend;
            ParticleColor = Color.FromNonPremultiplied(255, 255, 255, 50);
        }
        /// <summary>
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (timeTillPuff < 0)
            {
                ...
                where.X = Global.Helper.RandomBetween(1712, 1776);
                where.Y = 637;
