...
{
    public class AlleyParticle : ParticleEngine
    {
        int particleAlpha;
        bool active;
        float time;
        ...
        protected override void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            p.Acceleration.X += Global.Helper.RandomBetween(100, 120);
            p.Acceleration.Y += Global.Helper.RandomBetween(-20, 20);
        }
